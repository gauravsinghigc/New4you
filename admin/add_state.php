      ...
      <div class="card">
       <div class="card-header">
        <h4 class="users-action"><?php echo $title_name; ?> <i class="fa fa-angle-right"></i>
         <a href="add_state.php"><i class="fa fa-plus"></i> State</a>
        </h4>
        ...
        <div class="card-body">
         <form action="insert.php" method="POST" enctype="multipart/form-data">
           ...
           <div class="row">
            <div class="col-sm-6">
             <div class="form-group">
              ...
              <input name="state_name" class="states order-alpha form-control" required="">
             </div>
            </div>
           </div>
          </div>
          ...
          <div class="panel-footer text-right">
           <a href="states.php" class="btn btn-default">Back to States</a>
           <button class="btn btn-success" type="submit" name="SaveNewState">Create State</button>
          </div>
         </form>
        </div>
       </div>
