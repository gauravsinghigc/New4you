									...
									<div class="card-body">
										<form action="insert.php" method="POST" enctype="multipart/form-data">
												...
												<div class="row">
													<div class="col-sm-6">
														<div class="form-group">
															...
															<select class="form-control" required="" name="product_cat_id" <?php if (isset($_GET['warning'])) {
                                                                                                                            echo "has-error";
                                                                                                                        } else {
                                                                                                                        }; ?>>
                                                            ...
                                                            $sql = "SELECT * FROM product_categories where store_id='$store_id'";
													...
													<div class="col-sm-6">
														<div class="form-group">
															<label class="control-label">Sub Catgeory Title</label>
															<input type="text" name="sub_cat_title" value='' class="form-control" required="">
														</div>
													</div>
													<div class="col-sm-6">
														<div class="form-group">
															<label class="control-label">Sub Catgeory Image</label>
															<input type="FILE" name="sub_cat_img" value='' class="form-control" required="">
														</div>
													</div>
												</div>
											</div>
											...
											<div class="panel-footer text-right">
												<a href="sub_categories.php" class="btn btn-default">Back to Sub
													Category</a>
												<button class="btn btn-success" type="submit" name="create_pro_sub_cat">Create Sub Category</button>
											</div>
										</form>
									</div>
								</div>
