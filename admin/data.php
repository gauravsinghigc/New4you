    ...
    <div class="modal-dialog modal-xl" role="document">
     <div class="modal-content">
      <div class="modal-header">
       <h4 class="modal-title" id="myModalLabel17"><?php echo $title_name;?><i class="fa fa-angle-right"></i> ADD Data
       </h4>
      ...
      <div class="card">
       <div class="card-header">
        <h4 class="users-action"><?php echo $title_name;?> <i class="fa fa-angle-right"></i>
         <a href="" data-toggle="modal" data-target="#add_users"><i class="fa fa-plus"></i> ADD Data</a>
        </h4>
          ...
          <table id="users-list-datatable" class="table">
           <thead>
            <tr>
             ...
             <th style="width: 22%;">FULL_NAME</th>
             <th style="width: 33%;">EMAIL_ID</th>
            ...
            <?php
                              if (isset($_GET['ut'])) {
                                ...
                                $SelectUsers = "SELECT * FROM users, user_types where users.user_role=user_types.user_type_id and user_types.user_type_title='$ut'";
                                 ...
                                 $SelectUsers = "SELECT * FROM users, user_types where users.user_role=user_types.user_type_id and user_status='deleted'";
                               }
