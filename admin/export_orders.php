...
<head>
 ...
 <title>Delivery Orders : <?php echo $PosName; ?></title>
     ...
     <div class="users-list-table">
      <div class="card">
       <div class="card-header">
        <h4 class="users-action"><i class="fa fa-truck text-warning"></i> Delivery Sheet <i
            ...
            <?php
												...
												if ($user_role == "SUPER_ADMIN") {
													...
													if (isset($_GET['order_type'])) {
														...
														$sql = "SELECT * FROM customer_orders, customers where customer_orders.store_id='$store_id' and customers.customer_id=customer_orders.customer_id and customer_orders.order_status!='DELIVERED' and customer_orders.order_status!='REJECTED' and customer_orders.order_status!='UNDELIVERED'";
														$query = mysqli_query($con, $sql);
													}
												}
