...
<head>
    ...
    <title>Influencer TEAM : <?php echo $PosName;?></title>
                      ...
                      <form action="insert.php" method="POST">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                           ...
                           <input type="text" class="form-control" name="user_role" value='OFF_ROLE' disabled placeholder="Full Name" required="">
                            </div>
                          </div>
                              ...
                              <tr>
                                ...
                                <td>
                                 <form action='team_edit.php' method="POST">
                                  <button type="submit" value="<?php echo $user_id;?>" name='id' class="btn btn-link btn-outline-success btn-sm"><i class="fa fa-edit"></i></button>
                                </form>
                                </td>
                                <td>
                                  <form action='team_edit.php' method="POST">
                                  <button type="submit" value="<?php echo $user_id;?>" name='id' class='btn btn-link text-info btn-sm font-small-3'><?php echo $full_name;?></button>
                                   </form>
                                 </td>
