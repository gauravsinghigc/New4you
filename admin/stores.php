...
<body class="vertical-layout vertical-menu-modern 2-columns fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
  ...
  <div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" id="myModalLabel17">All STORES <i class="fa fa-angle-right"></i>
                ADD STORE</h4>
            ...
            <div class="modal-body">
              <form action="insert.php" method="POST">
                ...
                if ($user_role == "TEAM_LEADER") { ?>
                  <input type="text" name="upper_id" value="<?php echo $user_id; ?>" hidden>
                <?php  } else {
                  $user_id = $_SESSION['user_id'];
                ...
                ?>
                  <input type="text" name="upper_id" value="<?php echo $ref_id; ?>" hidden>
                <?php } ?>
                <div class="row">
                  <div class="col-md-12 col-lg-12 col-sm-12">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="user_owner_id">
                        ...
                        $countstoreowners = mysqli_num_rows($SelectUserTypesQuery);
                        if ($countstoreowners == 0) {
                          echo "<option value='null'>No Store Owner Found</option>";
                        }
                        while ($SelectUserTypesFetch = mysqli_fetch_assoc($SelectUserTypesQuery)) {
                          ...
                          <option value="<?php echo $store_user_id; ?>">
                            UID<?php echo $store_user_id; ?> :
                            <?php echo $store_owner_full_name; ?> :
                            <?php echo $store_owner_email_id; ?> :
                            <?php echo $store_owner_phone_number; ?></option>
                        <?php } ?>
                      </select>
                      <i class="fa fa-angle-right"></i> <a href='store_owners.php'>Add Store
                        Owner</a>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>Domain Type <small><i class="fa fa-angle-right"></i> (Domain
                          Price ADD in Activation if it is Direct Domain)</small> </label>
                      <select class="form-control" name="domain_type" required="">
                        <option value="MAIN_DOMAIN">DIRECT DOMAIN (eg: storename.extn)
                        </option>
                        <option value="SUB_DOMAIN">SUB DOMAIN (eg: storename.mobilabs.in)
                        </option>
                        <option value="DIR_DOMAIN">DIRECTORY DOMAIN (eg:
                          mobilabs.in/storename) </option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>Enter Domain Name <small><i class="fa fa-angle-right"></i> like
                          storename.com, storename.in </small> </label>
                  ...
                  <div class="col-lg-12">
                    <hr>
                    <h4><b>Payment Gateway: <small><i class="fa fa-angle-right"></i> Default
                          Payment Gateway is PAYTM for all Customer for Direct Payment
                          Receiving.</small></b></h4>
                  </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>PROD_MID <small><i class="fa fa-angle-right"></i> (if PAYMENT
                          GATEWAY is STORE OWNER else fill NA)</small> </label>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>PROD_KEY <small><i class="fa fa-angle-right"></i> (if PAYMENT
                          GATEWAY is STORE OWNER else fill NA)</small> </label>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>WEBSITE TYPE <small><i class="fa fa-angle-right"></i> (if PAYMENT
                          GATEWAY is STORE OWNER else fill NA)</small> </label>
                  ...
                  <div class="col-lg-12">
                    <hr>
                    <h4><b>Activation By: <small><i class="fa fa-angle-right"></i>
                          UID<?php echo $user_id; ?> : <?php echo $full_name; ?>
                        </small></b></h4>
                  </div>

                  <div class="col-md-4">
                    <div class="form-group">
                      <label>ACTIVATION FEE <small><i class="fa fa-angle-right"></i> Inclusive
                          of ALL Tax.</small> </label>
            ...
            <div class="modal-footer">
              ...
              <button type="Submit" name="REGISTER_NEW_STORE" class="btn btn-outline-primary">CREATE
                Data</button>
              </form>
            </div>
          </div>
      ...
      <div class="modal fade text-left" id="add_store_owners" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" id="myModalLabel17">All OWNERS <i class="fa fa-angle-right"></i>
                ADD Owner</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="user_role">
                        ...
                        while ($SelectUserTypesFetch = mysqli_fetch_assoc($SelectUserTypesQuery)) {
                          ...
                          <option value="<?php echo $UserTypeid; ?>" selected>
          ...
          <div class="users-list-table">
            <div class="card">
              <div class="card-header">
                <h4 class="users-action mobile-font-size">All Stores <i class="fa fa-angle-right"></i>
                  <a href="store_activation.php">
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped zero-configuration" style='font-size:12px;'>
                      ...
                      <tbody>
                        <?php
                        $selectstore = "SELECT * from stores, users where stores.user_id=users.user_id";
                        ...
                        while ($storefetch = mysqli_fetch_assoc($selectquery)) {
                          ...
                          <tr>
                            ...
                            <td>
                              <a href='store_edit.php?store_id=<?php echo $StoreId; ?>'>
                                <?php echo $Storename; ?>
                              </a>
                            </td>
