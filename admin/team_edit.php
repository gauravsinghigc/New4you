...
if (isset($_POST['id'])) {
    $user_view_id = $_POST['id'];
    $_SESSION['id'] = $_POST['id'];
} else {
    $user_view_id = $_SESSION['id'];
}
      ...
      <div class="card-content">
       <div class="card-body">
        ...
        <div class="tab-content">
           ...
           <div class="row">
            <div class="col-md-4">
             <div class="form-group">
              ...
              <input type="text" class="form-control" name="user_type_id" value="<?php echo $user_role_cr; ?>"
         ...
         <div class="modal-footer">
          <a class="btn grey btn-outline-secondary" data-dismiss="modal">Close</a>
          <button type="Submit" name="UPDATE_STORE" class="btn btn-outline-primary">Update Data</button>
          </form>
          <?php } ?>
         </div>
        </div>
