...
if (isset($_GET['UserViewID'])) {
    ...
    $_SESSION['UserViewID'] = $_GET['UserViewID'];
    $user_id_check = $UserViewID;
} else {
    $UserViewID = $_SESSION['UserViewID'];
    $user_id_check = $UserViewID;
}

$sql = "SELECT * FROM users, user_types where user_id='$UserViewID' and users.user_role=user_types.user_type_id";
...
$user_verify = $fetch['user_verification'];
$user_verification_check = $fetch['user_verification'];
if ($user_status_check == "Inactive") {
...
if ($user_img == null) {
    $userimg_c = "app-assets/images/portrait/small/avatar-s-26.png";
} else {
    $userimg_c = $fetch['user_img'];
}
$sql = "SELECT * from stores where stores.user_id='$UserViewID'";
$query =  mysqli_query($con, $sql);
$fetch =  mysqli_fetch_assoc($query);
							...
							<div class="card-content">
								<div class="card-body">
									<ul class="nav nav-tabs mb-2" role="tablist">
										<li class="nav-item">
											<a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab" href="#account" aria-controls="account" role="tab"
												aria-selected="true">
												<i class="fa fa-user mr-25"></i>Account<span class="d-none d-sm-block"></span>
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link d-flex align-items-center" id="documents-tab" data-toggle="tab" href="#documents" aria-controls="documents" role="tab"
												aria-selected="false">
												<i class="fa fa-file mr-25"></i>Documents<span class="d-none d-sm-block"></span>
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link d-flex align-items-center" id="setting-tab" data-toggle="tab" href="#setting" aria-controls="setting" role="tab" aria-selected="false">
									...
									<div class="media mb-2">
										<a class="mr-2" href="#">
											<img src="<?php echo $userimg_c; ?>" alt="<?php echo $full_name; ?>" title="<?php echo $full_name; ?>" class="users-avatar rounded-circle" height="64"
												width="64">
										</a>
												...
												<div class="modal-content">
													...
													<div class="modal-body">
														<form class="form" action="update.php" method="POST" enctype="multipart/form-data">
															...
															<input type="text" name="user_id" value="<?php echo $UserViewID; ?>" hidden>
															<div class="row">
																<div class="col-md-12">
									...
									<div class="tab-content">
												...
												<div class="row">
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" name="user_type_id" value="<?php echo $user_role_id; ?>" hidden="">
															<input type="text" class="form-control" value="<?php echo $user_role_cr; ?>" placeholder="USER_ROLE" readonly="">
														</div>
													</div>
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="full_name" value="<?php echo $full_name_user; ?>" placeholder="Full Name" required="">
														</div>
													</div>
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="email" class="form-control" name="email_id" value="<?php echo $email_id; ?>" placeholder="Email Id" required="">
														</div>
													</div>
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="phone_number" value="<?php echo $phone_number; ?>" placeholder="+91" required="">
														</div>
													</div>
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control" value="<?php echo $user_address; ?>" name="user_address" placeholder="H no/Flat no/Street Address"
																required="">
														</div>
													</div>
													...
													<div class="col-md-4">
														<div class="form-group">
															<label>City</label>
															<input type="text" class="form-control" value="<?php echo $user_city; ?>" name="user_city" placeholder="City" required="">
														</div>
													</div>
													...
													<div class="col-md-4">
														<div class="form-group">
															<label>State</label>
															<input type="text" class="form-control" name="user_state" value="<?php echo $user_state; ?>" placeholder="State" required="">
														</div>
													</div>
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="user_pincode" value="<?php echo $user_pincode; ?>" placeholder="Pincode" required="">
													...
													<div class="col-md-4" <?php echo $Hide; ?>>
														<div class="form-group">
															...
															<select class="form-control" name="user_verification">
																<?php if ($user_verify == "verified") {
                                                                echo "<option value='$user_verify'>$user_verify</option>";
										...
										<div class="tab-pane" id="documents" aria-labelledby="documents-tab" role="tabpanel">
											...
											<div class="row">
												<div class="col-lg-12">
													<h4 class="ml-0 pl-0">Uploaded Documents <i class="fa fa-angle-right"></i>
														<small>Compulsory documents pancard, adhaar card.</small>
													</h4>

													<table class="table" style="width: 100% !important;">
														<?php
                                                    $sql = "SELECT * FROM user_documents, user_documents_types where user_documents.user_id='$UserViewID' and user_documents.document_id=user_documents_types.document_id ";
                                                    $query =  mysqli_query($con, $sql);
                                                    ...
                                                    if ($countdoc == 0) {
														...
														<tr>
															...
															<td>
																<a href="USER_DATA/userdoc/<?php echo $fetch['document_file']; ?>" target='blank'><i class="fa fa-eye"></i>
																	<?php echo $fetch['document_file']; ?></a>
															</td>
															<td><?php echo $fetch['document_status']; ?> at <?php echo $fetch['update_date']; ?></td>
														</tr>
														<?php }
                                                    } ?>
													</table>
											...
											<form action="insert.php" method="POST" enctype="multipart/form-data">
												...
												<div class="row">
													<div class="col-lg-12">
														<hr>
														<hr>
														<h6 class="ml-0 pl-0">Upload New Documents</h6>
													</div>
										...
										<div class="tab-pane" id="setting" aria-labelledby="setting-tab" role="tabpanel">
											<!-- users edit Info form start -->
											<form action="update.php" method="POST">
												<input type="text" name="user_id" value="<?php echo $UserViewID; ?>">
												<input type="text" name="cr_url" value="<?php echo get_url(); ?>" hidden>
												...
												<div class="row">
													...
													<div class="col-md-6 col-lg-6 col-sm-12">
														<div class="form-group">
															...
															<input class="form-control" type="text" value="" name="cr_password" required="" placeholder="<?php echo $password; ?>">
														</div>
													</div>
													<div class="col-md-6 col-lg-6 col-sm-12">
														<div class="form-group">
