  ...
  <div class="custom-container">
   <div class="checkout-page contact-page">
    <div class="checkout-form">
     ...
     <div class="row">
      <div class="col-md-12">
       <h2 class="mt-3">Select Billing Address</h2>
      </div>
         ...
         <div class="rounded-1 p-2 bg-light shadow-sm" style="height:100% !important;">
          <form action="finalcheckout.php" method="POST">
           <div class="form-group">
            ...
            <button class="btn btn-success btn-sm mt-2" type="submit" name="billing_address"
             value="<?php echo $CombineAdddress1; ?>">Billing to This Address</button>
      ...
      <div class="col-lg-5 col-md-5 col-12">
       <form action="insert.php" method="POST">
        <input type="text" name="url" value="billing.php" hidden="">
        <div class="form-group col-md-12 col-sm-12 col-xs-12">
         <br>
