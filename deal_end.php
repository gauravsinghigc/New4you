    ...
    <div class="row">
      <div class="col pr-0">
        <div class="product-slide-6 no-arrow">
          <?php
          $sql = "SELECT * FROM user_products, product_categories, product_sub_categories, pro_brands where user_products.product_cat_id=product_categories.product_cat_id and user_products.product_sub_cat_id=product_sub_categories.sub_cat_id and user_products.product_brand_id=pro_brands.brand_id and user_products.product_type='TODAY_DEALS' ORDER BY user_product_id DESC limit 0, 15";
      ...
      <div class="col-md-12 text-center">
        <a href="products.php?view=TODAY_DEALS" class="btn btn-md btn-secondary text-white">View All Products <i class="fa fa-angle-right"></i></a>
      </div>
      <br>
    </div>
  </div>
