...
<body>
  ...
  <section class="section-big-py-space b-g-light">
    ...
    float:right !important;">
                      ...
                      <hr>
                      <h6 class="font-2" style="font-size: 15px;"><i class="fa fa-shopping-cart font-3"></i> <b>ORDER ID :
                          #<?php echo $id; ?></b>
                        <br>
                        <span><i class="fa fa-calendar"></i> Date : <?php echo $order_date; ?></span><br>
                        <span><i class="fa fa-truck font-3"></i> Status : <?php echo $order_status; ?></span>
                      </h6>
                      <a href="track-order.php?order_id=<?php echo $id; ?>" class="btn btn-lg btn-info btn-sm text-white float-right font-3" style="margin-top:-7%;float:right !important;"><i class="fa fa-map-marker mt-0"></i> - <i class="fa fa-truck mt-0"></i> Track Order</a>
                    </div>
                    <div class="row" style="width: 100% !important;">
                      <div class="col-md-12 col-lg-12" style="padding-left: 0%;padding-right: 1%;">
                        <h5 class="font-3">
                          <span style="font-size: 15px;color: green;float: right;background-color: white;box-shadow: 0px 0px 1px grey;padding: 1%;padding-left: 2%;border-radius: 20px;padding-right: 2%;">
                            <?php if ($payment_status == "NOT PAID" or $payment_status == "Not Paid") {
                              echo "<span class='text-danger'><i class='fa fa-warning mt-0'></i> $payment_status</span>";
                            } else if ($payment_status == "Txn Failed!") {
                              echo "<span class='text-danger'><i class='fa fa-warning mt-0'></i> $payment_status</span>";
                            } else {
                              echo "<span class='text-success'><i class='fa fa-check-circle mt-0'></i> $payment_status</span>";
                            }; ?></span>
                        </h5>
                      </div>
                      <div class="col-md-12 col-lg-12" style="padding-left: 0%; padding-right: 0%;">
                        ...
                        while ($fetch = mysqli_fetch_assoc($query)) {
                          ...
                          $total_amount_mrp2 += $mrp_total;
                        ?>
                          <div class="row pro-text-bg p-2 mt-2" style="background-color: #f3f3f3;">
                            <div class="col-sm-3 col-xs-4 col-4 p-2">
                              <img src="<?php echo $img_url; ?>/img/store_img/pro_img/<?php echo $fetch['product_img']; ?>" style='width: 78%;border-radius: 15px;margin-top: 7%;box-shadow: 0px 0px 1px grey;padding: 2%;' class="d-block mx-auto">
                            </div>
                            <div class="col-sm-9 col-xs-8 col-8 pt-3">
                              <p style="color: black; font-size: 14px;">
                                <i style="font-size: 14px;"></i><span style="font-size: 16px;">
                                  <?php echo html_entity_decode(ucfirst($fetch['product_names'])); ?><BR> <span class="text-grey fs-14" style="color:grey;font-size:14px !important;"><?php echo $hindi_name; ?></span></span><br>
                                ...
                                <b class="text-black" style="color:black !important;"> Qty :</b> <?php echo $Quantity; ?> <br>
                                <span style="float: right;
    font-size: 15px;
    margin-top: -14px;
"> Total : <i class="fa fa-inr"></i> <?php echo $fetch['product_price']; ?> x
                                  <?php echo $qty; ?> = <i class="fa fa-inr"></i><b style="font-size: 17px;"><?php echo $fetch['product_total_price']; ?></b></span><br>
                              </p>
                            </div>
                          </div>
                        ...
                        <table style="width: 100%; font-size: 14px;color: black;" class="price">
                          <tr style="box-shadow: 0px 0.1px 0px 0px grey;">
                            <th>MRP Total</th>
                            <td align="right">Rs.<?php echo $total_amount_mrp2; ?></td>
                          </tr>
                          <tr style="box-shadow: 0px 0.1px 0px 0px grey;">
                            <th>Product Price</th>
                          ...
                          <tr style="box-shadow: 0px 0.1px 0px 0px grey;">
                            ...
                            <td align="right"><b style="font-size: 17px; color: green;float: right;">
                                <?php if ($payment_status == "NOT PAID" or $payment_status == "Not Paid") {
                        ...
                        <div class="row">
                          <div class="col p-2 mt-4 address">
                            <b>Shipping Address:</b><br>
                            <hr class="mt-2 mb-2">
                            <?php echo html_entity_decode($delivery_address); ?><br><br>
                          </div>
                          <div class="col p-2 mt-4 text-right address">
                            <b>Billing Address:</b><br>
                            <hr class="mt-2 mb-2">
                            <?php echo html_entity_decode($billing_address); ?><br><br>
                          </div>
                        </div>
                        <p style="width: 100% !important;float: left;color: black;" class="mb-0 mt-0">
                          <b><i class="fa fa-truck text-info mt-0"></i> DELIVERY SLOT <i class="fa fa-angle-right"></i></b>
                          <?php echo $PICK_SCHEDULE_TIME; ?>
                        </p>


                        <h5 style="color: black;float: left;width: 100%;">
                          <hr><b>Order Information</b>
                        </h5>
                        <style type="text/css">
                          table.info tr td,
                          th {
                        ...
                        <table style="width: 100%; color: black; font-size: 14px;" class="info">
                          ...
                          <tr>
                            <th>Payment Mode</th>
                            <td><?php if ($payment_mode == "CASH PAYMENT") {
                                  echo "Cash Payment";
                                } else {
                                  echo strtoupper($payment_mode);
                                } ?></td>
                          </tr>
                          <tr>
                            <th>Coupon & Rewards Points</th>
                            <td><?php if ($coupon_code == "REWARD POINTS") {
                                  echo "Reedemed";
                                } else {
                                  echo $coupon_code;
                                } ?> <?php if ($coupon_code == "REWARD POINTS") {
                          ...
                          <tr>
                            <td colspan="2" style="width:55% !important;"><br><b>Payment Note:</b> <br><?php echo $payment_note; ?>
                            </td>
                          </tr>
                        </table>
                        <hr>
                        <div class="row">
                          <div class="col">
                            <p>
                            <h3 class="font-15">Store Information:</h3>
                            <span style="font-size: 13px;"><b><?php echo $store_name; ?></b></span><br>
                            <?php echo $store_phone; ?><br>
                            <?php echo $store_mail_id; ?><br>
                            <i class="fa fa-map-marker text-warning"></i> <?php echo $store_address; ?>
                            <?php echo $store_arealocality; ?> <?php echo $store_city; ?><br>
                        ...
                        <br>
                        <p class="text-center">
                          <a href="invoice.php?order_id=<?php echo $order_id; ?>" class="btn btn-md btn-success" target="blank"><i class="fa fa-file mt-0"></i> View Invoice</a>
                        </p><br>
