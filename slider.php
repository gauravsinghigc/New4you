  ...
  <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1600px;height:480px;overflow:hidden;">
    ...
    while ($fetch = mysqli_fetch_assoc($query)) {
      ...
      <div style="background-color:white;">
        <img data-u="image" style="opacity:0.8;" data-src="<?php echo $img_url; ?>/img/store_img/slider/<?php echo $slider_img; ?>" />
        <div data-ts="flat" data-p="275" data-po="40% 50%" style="left:150px;top:40px;width:1600px;height:480px;position:absolute;">
        </div>
      </div>
    <?php
    } ?>
