...
<head>
      ...
      <title><?php echo $store_name;?> :  Add Address</title>
                                 ...
                                 <div class="row">
                                    <div class="col-sm-12">
                                       <div class="form-group">
                                          ...
                                          <input class="form-control border-form-control" name="street_address" value="" placeholder="" type="text">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-sm-6">
                                       <div class="form-group">
                                          ...
                                          <input class="form-control border-form-control" name="area_locality" value="" placeholder="" type="text">
                                       </div>
                                    </div>
                                    <div class="col-sm-6">
                                       <div class="form-group">
                                          <label class="control-label">City<span class="required">*</span></label>
                                          <input class="form-control border-form-control" name="customer_city" value="" placeholder="" type="text">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-sm-6">
                                       <div class="form-group">
                                          ...
                                          <input class="form-control border-form-control" name="customer_state" value="" placeholder="" type="text">
                                       </div>
                                    </div>
                                    <div class="col-sm-6">
                                       <div class="form-group">
                                          <label class="control-label">Pincode<span class="required">*</span></label>
                                          <input class="form-control border-form-control" name="address_pincode" value="" placeholder="" type="text">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                       <div class="form-group">
                                          ...
                                          <input class="form-control border-form-control" name="alternate_phone" value="" placeholder="" type="text" >
                                       </div>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-sm-12 text-right">
                                       <button type="submit" name="add_customer_address" class="btn btn-success btn-lg"> Save Address </button>
                                    </div>
                                 </div>
