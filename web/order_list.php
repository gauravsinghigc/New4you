...
<html lang="en">
    ...
    <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
         <title><?php echo $store_name;?> :  My Orders</title>
                                    ...
                                    <div class="widget">
                                        <div class="section-header">
                                            <h5 class="heading-design-h5">
                                               <i class="fa fa-shopping-cart text-warning"></i> All Orders
                                            </h5>
                                            <hr>
                                        </div>
                    ...
                    <div class="col-xs-12 col-sm-12 mb-2 bg-white">
                        <div class="row" style="padding:1%; border-radius:5px;background-color: #f3f1f1;">
                            <div class="col-sm-1 col-xs-2 col-2" style='padding:0%;'>
                                <img src='img/referral-icon2.png' class='img-fluid text-center' style='background-color: #80808040;
    border-radius: 50%;
    padding: 10%;
    margin-top: 17%;'>
                            </div>
    ...
    box-shadow: 0px 0px 1px grey;">
                    ...
                    if($order_status == "NEW ORDER"){
                      ...
                      echo "<i class='fa fa-info text-danger'></i> $order_status";
                                    ...
                                    <a href="order_details.php?id=<?php echo $fetch['order_id']; ?>"
                                        class='btn btn-sm btn-success text-white float-right' style="margin-top: -7%; margin: 0.5%;"><i class="fa fa-list mt-0"></i> Details</a>
                                    <a href="invoice.php?order_id=<?php echo $fetch['order_id']; ?>"
                                        class='btn btn-sm btn-success text-white float-right' target="blank" style="margin-top: -7%;margin: 0.5%;"><i class="fa fa-file mt-0"></i> Invoice</a>
                                    <a href="track-order.php?order_id=<?php echo $fetch['order_id']; ?>"
                                        class='btn btn-sm btn-success text-white float-right' style="margin-top: -7%;margin: 0.5%;"><i class="fa fa-map-marker mt-0"></i> Track</a>
