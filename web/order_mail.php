...
SendMail(
             ...
             $MAIL_MSG = "
             <center>
             <img src='http://24kharido.in/img/tick.gif' style='width:60%; border-radius:150px;'>
             </center>
             <p>Order ID #$order_id is placed successfully. Order Details are; <br><br>
             Amount  : Rs.$payment_amount<br>
             Payment Mode : $payment_mode<br>
             Payment Status : $payment_status<br>
             Delivery Slot : $PICK_SCHEDULE_TIME<br><br>
             
             To know more about order details;<br>
             -> Go to 24kharido.in<br>
             -> Login with your account.<br>
             -> Go to My Orders.<br>
             -> You can se your order $order_id.<br>
             -> Click on Order Id ($order_id).<br>
             -> Your Order Details are show.<br><br>
             
             To Track your order or delivery status<br>
             -> Go to 24kharido.in<br>
             -> Go to Track Order Option.<br>
             -> Enter your order id.<br>
             -> Click on Get Status.<br><br>
             
             RewardPoints:<br>
             You earned Rs.$RewardPoints on Order id $order_id. it will be created into your account soon.</p>
             
             <p>If you have any query related to your order then feel free to contact us at $store_phone or mail us at $store_mail_id.</p>"
);
          ...
          echo "<h2>Something went wrong</h2> <h3>Unable to Save Cart Items into Ordered Products Tables.</h3>";
        }

  } else {
    //create final order for customer having some errors.
    ini_set("display_errors", 1);
    echo "<h2>Something went wrong</h2> <h3>Unable to Create Order.</h3>";
  }
