<?php require 'files.php'; include 'include.php';
...
<head>
      ...
      <title><?php echo $store_name;?> : Reset Password</title>
...
<section class="container-fluid" style="background-image: url('img/lucrezia-carnelos-wQ9VuP_Njr4-unsplash.jpg'); background-size: cover; background-repeat: no-repeat; background-position: center; padding: 6%;">
  <div class="row mb-4">
    <div class="col-lg-6 col-md-6 col-sm-12 col-12 col-xs-12 bg-white mx-auto p-4 text-center">
      <img src="<?php echo $logo;?>" class="img-fluid d-block mx-auto mt-0" style="width: 50%;">
      <h4 class="title text-center"><i class="fa fa-edit text-info"></i> Password Reset</h4><hr>
      <?php 
