...
<head>
      ...
      <title><?php echo $store_name;?> : Terms & Conditions</title>
   ...
   <body style="font-size: 15px !important;">
      ...
      <section class="pt-3 pb-3 page-info section-padding border-bottom bg-white">
         <div class="container-fluid">
            <div class="row">
               <div class="col-md-12">
                  <a href="index.php"><strong><span class="fa fa-home"></span> Home</strong></a> <span class="fa fa-angle-right"></span> <a href="about-us.php">About Us</a> <span class="fa fa-angle-right"></span> Terms & Conditions
               </div>
            </div>
         </div>
      </section>
      <section class="container-fluid">
         ...
         <div class="col-md-12 col-lg-12 col-sm-12 p-1" style="text-align: justify; padding-left: 1% !important;">
            <h3 class="mt-2"><?php echo $store_name;?> Terms & Conditions</h3>
<p>
...
<p>Should you have any clarifications regarding the Terms of Use, please do not hesitate to contact us at support@24kharido.in</p>
...
<p>
Transactions through the Marketplace may be subject to a delivery charge where the minimum order size is not met. You will be informed of such delivery charge at the stage of check-out for a transaction through the Marketplace.</p>
<h4>
Eligibility</h4>
<p>
...
2. is grossly harmful, harassing, blasphemous, defamatory, obscene, pornographic, paedophilic, libelous, invasive of another’s privacy, hateful, or racially, ethnically objectionable, disparaging, relating or encouraging money laundering or gambling, or otherwise unlawful in any manner whatever;<br>
...
9. threatens the unity, integrity, defence, security or sovereignty of India, friendly relations with foreign states, or public order or causes incitement to the commission of any cognizable offense or prevents investigation of any offense or is insulting any other nation;<br>
...
<p>
Subject to the foregoing, the price mentioned at the time of ordering a product shall be the price charged at the time of delivery, provided that no product offered for sale on the Marketplace will be sold at a price higher than its MRP (Maximum Retail Price).</p>

<h5>
Coupons And Promo Codes</h5>
<p>
From a time to time, the Company may at its discretion offer a user promotional codes or coupons entitling you to encash the applicable value of such codes/coupons against purchases made on the Marketplace. Unless specifically stated on the code or coupon, a promotional code or coupon shall:<br>
...
<p class="text-danger"><code><b>NOTE</b></code> Currently we are not Accepting Payment Online. We accept payment at delivery time in cash/wallet(Paytm)/Google Pay/Phone Pay/UPI methods. So, in case someone request for this type of request please send that information to us at support@24kharido.in. We accept only payment at delivery time.<br>
As we start accepting payment online we will inform you via mail and sms.</p>

<h5>
Cancellations</h5>
<p>
• As a user, you may cancel an order placed by you before the order enters the “Enroute” stage. For any permitted cancellations, we will refund payments, if any, made by you under the relevant order within approximately 48-72 hours.<br>
...
Returns & Refunds</h5>
<p>
• To combat the Corona pandemic, we’re minimising contact points, and hence, will not be able to process returns if not done at doorstep,each return request will be reviewed and actioned considering current situation, all below benefits of return policy are void till 31st December’20.<br>
• The Marketplace has a “no questions asked return and refund policy” which entitles all users who have purchased a product on the Marketplace to return the product at the time of delivery if they are not satisfied with the quality of the product. In case you are not available at delivery to check the quality of the product(s), you may raise a complaint within 24-48 hours of delivery. Similarly, in case any product is not delivered at the time of delivery, you may raise a complaint within 48 hours of delivery.<br>
...
• You may request for a refund/replacement within 7 days of delivery, for Electronics and Cookware products with all original tags & packaging intact in case of any quality issues. It is also requested that a user should check if the product seal is intact (i.e. not broken) while accepting the order to avoid any kind of damage related complaints post delivery.<br>
• Further, it is clarified that for electronic and cookware products, no returns shall be accepted post 7 days of delivery and the user should get in touch with the Brand/Manufacturer with original invoice given at the time of delivery from 24kharido.<br>
...
Refund, if any, shall be made at the same issuing bank through which the Product was purchased. For cash on delivery transactions, the User has the option to receive the refund as 24kharido Cash in the 24kharido wallet or the refund can be credited in any bank account via NEFT (for which the User shall have to share the bank details).<br>
...
• You agree to use the services provided by the Company for lawful purposes only, and comply with all applicable laws and regulations while using/accessing and transacting on the Marketplace.<br>
• You will provide authentic and true information in all instances where any information is requested of you. The Company reserves the right to confirm and validate the information and other details provided by you at any point of time.<br>
• If at any time, the information provided by you is found to be false or inaccurate (wholly or partly), the Company shall have the right in its sole discretion to reject registration, cancel all orders, and debar you from using its services and other affiliated services in the future without any prior intimation whatsoever, and without any liability to you.<br>
• You are accessing the services made available by the Company and transacting at your sole risk and are using your best and prudent judgement before entering any transaction through the Marketplace.<br>
• Before placing an order, you acknowledged to have checked and reviewed the product description carefully and in sufficient detail. By placing an order on the Marketplace, you agree to be bound by the conditions of sale included in the item’s description without exception.<br>
...
24kharido<br>
9871620117<br>
Near Mashjid, Sector 3, Faridabad Haryana -121004.<br>
Email: support@24kharido.in<br>
</p>
